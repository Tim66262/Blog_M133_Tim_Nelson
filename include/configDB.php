<?php
  ...
  setValue("cfg_func_login", array("login","blogs","entries_public"));
  ...
  setValue("cfg_menu_login", array("login"=>"Login","blogs"=>"Blog wählen","entries_public"=>"Beiträge anzeigen","import"=>"Benutzer importieren","export"=>"Benutzer exportieren"));
  ...
  setValue("cfg_menu_member", array("entries_member"=>"Beiträge anzeigen","entry_add"=>"Beitrag hinzufügen","entry_edit"=>"Beitrag ändern","logout"=>"Logout"));
	//  setValue("cfg_menu_disabled", array("entries_public","entry_edit"));
  setValue("cfg_menu_disabled", array("entries_public"));
